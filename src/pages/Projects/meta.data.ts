...
const projects: Array<Project> = [
  {
    ...
    content:
      'Is a multiplayer mobile online game, where the player should pick their battle hand within 5 seconds, the player who will win got 5 crown points, the purpose of this project is to make you bonding with your friends or family, its Tech Stack is MERN composed of MongoDB, Express, React Native and Node JS, this is the first game that I made in my college just for fun and make myself known about fullstack environment.'
  },
  {
    src: broowingCoffeeImg,
    name: 'Broowing Coffee',
    content:
      "Is a mobile web point of sale and inventory management with a real life design scenario, create product, include the inventory, create transaction with an e-receipt at the same time the deduction of inventory simultaneously, and yes it can also create reports depends on what user's specified date, this application runs in React JS, Expresss, NodeJS and MongoDB."
  },
  {
    src: budgetMangrImg,
    name: 'Budget Manager',
