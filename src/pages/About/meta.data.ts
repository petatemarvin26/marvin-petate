...
const contents: Array<Content> = [
  {
    data: [
      "Hi there!, I graduated with Bachelor of Science in Information Technology specialize the software engineering and development. I start programming when I was high school at year 2016, creating website with javascript but I didn't see myself having interest with, I went to senior high school and met java which I should call my first love programming language, I play with java creating programs, mobile applications and window based applications, java is my foundation for all different programming languages, it gives me an idea about the core concept of programming and what clean architecture paradigms are",
      'In college, I still continue exploring more about java, I went to competition in school Mobile Development we won as 1st runner up, I felt myself like, there is nothing new on what I am doing, maybe I was just exhausted in java, I dont see entertainment on java that time, so I realize why dont I try javascript again, since there is one professor introduce that in the class and suggest the React Native which sounds interesting, it is a croos-platform framework that deals with android, swift and javascript, so I search and read about the updates in javascript on year 2020 and I found NodeJS, React Native and React JS, I use React JS in my thesis and by 2021 I started my first freelance project as React Native Developer'
    ]
  },
  {
    data: [
